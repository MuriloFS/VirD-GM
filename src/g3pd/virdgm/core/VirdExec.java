...
public interface VirdExec {
	 ...
	 * */
    public boolean exec(String actionAttr, String valueAttr, String inputPosAttr, String outputPosAttr, Integer iteratorAttr, VirdMemory memory, ObjectOutputStream oos);
    /**
	 * @param actionAttr	Acao a ser avaliada
	 * @param valueAttr		Valor para testes
	 * @param inputPosAttr	Posicoes da memoria com os paramentros de entrada
	 ...
	 * */
    public boolean send(String actionAttr, String valueAttr, String inputPosAttr, String outputPosAttr, Integer iteratorAttr, VirdMemory memory, String host, Integer port);
}
